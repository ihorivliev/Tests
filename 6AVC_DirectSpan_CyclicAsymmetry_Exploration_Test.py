# Script Name: AVC_DirectSpan_CyclicAsymmetry_Exploration_Test.py
...
if __name__ == "__main__":
    ...
    P_A_val_sym = Symbol("PA_val_DSCPath", solver_INT_TYPE)
    P_B_val_sym = Symbol("PB_val_DSCPath", solver_INT_TYPE)
    
    X_L_val_fixed = Symbol("XL_val_DSCPath", solver_INT_TYPE) 
    ...
    for current_local_span_S_py in LOCAL_SPANS_TO_TEST:
        ...
        AS_reached_val = current_R_L_val

        # --- Path 1 (Subtractive Descent - Control) ---
        s.push()
        current_S1_L_val = AS_reached_val
        path1_ops_debug_info = []
        ...
        prove_or_find_counterexample(s, f"CPATH-1.A: Path 1 (Sub Descent) results in AS_L (S={current_local_span_S_py})", 
                                     [], prop_path1_is_AS,
                                     model_vars_to_print=[P_A_val_sym, P_B_val_sym, X_L_val_fixed, AS_reached_val, Res1_L_val],
                                     op_result_dicts_for_debug=ascent_ops_debug_info + path1_ops_debug_info)
        s.pop()
        ...
        setup_p2 = temp_p2["defining_assertions"] + Res2_L["defining_assertions"]
        prove_or_find_counterexample(s, f"CPATH-2: (AS_reached-AS_L)+X_L ~ X_L (S={current_local_span_S_py})", 
                                     setup_p2, prop_path2_is_XL,
                                     model_vars_to_print=[P_A_val_sym, P_B_val_sym, X_L_val_fixed, AS_reached_val, temp_p2["val_L_sym"], Res2_L["val_L_sym"]],
                                     op_result_dicts_for_debug=ascent_ops_debug_info + [temp_p2, Res2_L])
        s.pop()
        ...
        prove_or_find_counterexample(s, f"CPATH-3: AS_reached+X_L ~ X_L (S={current_local_span_S_py})", 
                                     Res3_L["defining_assertions"], prop_path3_is_XL,
                                     model_vars_to_print=[P_A_val_sym, P_B_val_sym, X_L_val_fixed, AS_reached_val, Res3_L["val_L_sym"]],
                                     op_result_dicts_for_debug=ascent_ops_debug_info + [Res3_L])
        s.pop()
        ...
        setup_p4 = temp_p4["defining_assertions"] + Res4_L["defining_assertions"]
        prove_or_find_counterexample(s, f"CPATH-4: (AS_reached-X_L)+X_L ~ X_L (S={current_local_span_S_py})", 
                                     setup_p4, prop_path4_is_XL,
                                     model_vars_to_print=[P_A_val_sym, P_B_val_sym, X_L_val_fixed, AS_reached_val, temp_p4["val_L_sym"], Res4_L["val_L_sym"]],
                                     op_result_dicts_for_debug=ascent_ops_debug_info + [temp_p4, Res4_L])
        s.pop()
        ...
        setup_p5 = temp_p5["defining_assertions"] + Res5_L["defining_assertions"]
        prove_or_find_counterexample(s, f"CPATH-5: (AS_reached+X_L)-X_L ~ ZS_L (S={current_local_span_S_py})", 
                                     setup_p5, prop_path5_is_ZS,
                                     model_vars_to_print=[P_A_val_sym, P_B_val_sym, X_L_val_fixed, AS_reached_val, temp_p5["val_L_sym"], Res5_L["val_L_sym"]],
                                     op_result_dicts_for_debug=ascent_ops_debug_info + [temp_p5, Res5_L])
        s.pop()
