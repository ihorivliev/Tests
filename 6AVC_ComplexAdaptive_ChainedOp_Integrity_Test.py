# Script Name: AVC_ComplexAdaptive_ChainedOp_Integrity_Test.py
...
# --- Configuration ---
LOCAL_SPANS_TO_TEST = [2, 3, 5, 7, 10] 
...
# CORRECTED: Parameter name made consistent
def define_local_op_complex_adaptive_archetype_result(
    op_canonical_definer_func: Callable, # Parameter name for the function handle
    ...
    if Y_L_val_sym is not None: 
        Y_canon_repr_mapped, y_canon_assertions = map_local_to_complex_adaptive_archetype_input_repr(
        ...
        Res_canon_repr = op_canonical_definer_func( # Call using the parameter name
...
if __name__ == "__main__":
    print("====== AVC Complex Adaptive Chained Operation Integrity Test ======\n")

    P_A_val_sym = Symbol("PA_val_CACOI", solver_INT_TYPE)
    P_B_val_sym = Symbol("PB_val_CACOI", solver_INT_TYPE)
    
    A_L = Symbol("A_L_CACOI", solver_INT_TYPE)
    B_L = Symbol("B_L_CACOI", solver_INT_TYPE)
    C_L = Symbol("C_L_CACOI", solver_INT_TYPE)
    D_L = Symbol("D_L_CACOI", solver_INT_TYPE)
    E_L = Symbol("E_L_CACOI", solver_INT_TYPE) 
    W_L = Symbol("W_L_CACOI", solver_INT_TYPE) 

    Fp1_L_coi5 = Symbol("Fp1_L_coi5", solver_INT_TYPE)
    Fp2_L_coi5 = Symbol("Fp2_L_coi5", solver_INT_TYPE)
    Fp3_L_coi5 = Symbol("Fp3_L_coi5", solver_INT_TYPE)


    for current_local_span_S_py in LOCAL_SPANS_TO_TEST:
        s = Solver(name="z3")
        current_local_span_S_smt = Int(current_local_span_S_py)
        effective_omega_py = COMPLEX_CANONICAL_OMEGA_FOR_S_GE_3_PY if current_local_span_S_py >=3 else (2 if current_local_span_S_py == 2 else 1)
        print(f"\n\n===== COMPLEX ADAPTIVE CHAINED OP TESTS WITH S = {current_local_span_S_py} (maps to Omega_eff_C = {effective_omega_py}) =====\n")
        ...
        # --- CACOI-1: FOIL-like Expansion: (A_L+B_L)*(C_L+D_L) ~ ((A_L*C_L)+(A_L*D_L)) + ((B_L*C_L)+(B_L*D_L)) ---
        s.push()
        sum_ab_c1 = define_local_op_complex_adaptive_archetype_result(define_smart_raw_add_canonical_result, A_L, B_L, P_A_val_sym, P_B_val_sym, "sAB_cacoi1")
        sum_cd_c1 = define_local_op_complex_adaptive_archetype_result(define_smart_raw_add_canonical_result, C_L, D_L, P_A_val_sym, P_B_val_sym, "sCD_cacoi1")
        lhs_cacoi1 = define_local_op_complex_adaptive_archetype_result(define_raw_mul_canonical_result, sum_ab_c1["val_L_sym"], sum_cd_c1["val_L_sym"], P_A_val_sym, P_B_val_sym, "lhs_cacoi1")

        prod_ac_c1 = define_local_op_complex_adaptive_archetype_result(define_raw_mul_canonical_result, A_L, C_L, P_A_val_sym, P_B_val_sym, "pAC_cacoi1")
        prod_ad_c1 = define_local_op_complex_adaptive_archetype_result(define_raw_mul_canonical_result, A_L, D_L, P_A_val_sym, P_B_val_sym, "pAD_cacoi1")
        prod_bc_c1 = define_local_op_complex_adaptive_archetype_result(define_raw_mul_canonical_result, B_L, C_L, P_A_val_sym, P_B_val_sym, "pBC_cacoi1")
        prod_bd_c1 = define_local_op_complex_adaptive_archetype_result(define_raw_mul_canonical_result, B_L, D_L, P_A_val_sym, P_B_val_sym, "pBD_cacoi1")
        sum_acad_c1 = define_local_op_complex_adaptive_archetype_result(define_smart_raw_add_canonical_result, prod_ac_c1["val_L_sym"], prod_ad_c1["val_L_sym"], P_A_val_sym, P_B_val_sym, "sACAD_cacoi1")
        sum_bcbd_c1 = define_local_op_complex_adaptive_archetype_result(define_smart_raw_add_canonical_result, prod_bc_c1["val_L_sym"], prod_bd_c1["val_L_sym"], P_A_val_sym, P_B_val_sym, "sBCBD_cacoi1")
        rhs_cacoi1 = define_local_op_complex_adaptive_archetype_result(define_smart_raw_add_canonical_result, sum_acad_c1["val_L_sym"], sum_bcbd_c1["val_L_sym"], P_A_val_sym, P_B_val_sym, "rhs_cacoi1")
        
        prop_cacoi1 = avc_equiv_local_val(lhs_cacoi1["val_L_sym"], rhs_cacoi1["val_L_sym"], P_A_val_sym, P_B_val_sym)
        setup_cacoi1 = (sum_ab_c1["defining_assertions"] + sum_cd_c1["defining_assertions"] + lhs_cacoi1["defining_assertions"] +
                        ...
                        sum_acad_c1["defining_assertions"] + sum_bcbd_c1["defining_assertions"] + rhs_cacoi1["defining_assertions"])
        prove_or_find_counterexample(s, f"CACOI-1 FOIL-like (S={current_local_span_S_py})", setup_cacoi1, prop_cacoi1,
                                     [P_A_val_sym,P_B_val_sym,A_L,B_L,C_L,D_L,lhs_cacoi1["val_L_sym"],rhs_cacoi1["val_L_sym"]], 
                                     op_result_dicts_for_debug=[sum_ab_c1, sum_cd_c1, lhs_cacoi1, prod_ac_c1, prod_ad_c1, prod_bc_c1, prod_bd_c1, sum_acad_c1, sum_bcbd_c1, rhs_cacoi1])
        s.pop()

        # --- CACOI-2: Zero Chain: (((A_L*B_L)/B_L)-A_L)*C_L ~ ZS_L ---
        if current_local_span_S_py >= 2: 
            s.push()
            s.add_assertion(is_local_DFI_val(B_L, P_A_val_sym, P_B_val_sym)) 
            
            prod_ab_c2 = define_local_op_complex_adaptive_archetype_result(define_raw_mul_canonical_result, A_L, B_L, P_A_val_sym, P_B_val_sym, "pAB_cacoi2")
            div_pab_b_c2 = define_local_op_complex_adaptive_archetype_result(define_raw_div_canonical_result, prod_ab_c2["val_L_sym"], B_L, P_A_val_sym, P_B_val_sym, "dAB_B_cacoi2")
            sub_term_a_c2 = define_local_op_complex_adaptive_archetype_result(define_smart_raw_sub_canonical_result, div_pab_b_c2["val_L_sym"], A_L, P_A_val_sym, P_B_val_sym, "sT_A_cacoi2")
            lhs_cacoi2 = define_local_op_complex_adaptive_archetype_result(define_raw_mul_canonical_result, sub_term_a_c2["val_L_sym"], C_L, P_A_val_sym, P_B_val_sym, "lhs_cacoi2")

            prop_cacoi2 = is_local_ZS_val(lhs_cacoi2["val_L_sym"], P_A_val_sym)
            setup_cacoi2 = (prod_ab_c2["defining_assertions"] + div_pab_b_c2["defining_assertions"] + 
                            sub_term_a_c2["defining_assertions"] + lhs_cacoi2["defining_assertions"])
            prove_or_find_counterexample(s, f"CACOI-2 Zero Chain (B_L is DFI) (S={current_local_span_S_py})", setup_cacoi2, prop_cacoi2,
                                         [P_A_val_sym,P_B_val_sym,A_L,B_L,C_L,lhs_cacoi2["val_L_sym"]],
                                         op_result_dicts_for_debug=[prod_ab_c2, div_pab_b_c2, sub_term_a_c2, lhs_cacoi2])
            s.pop()
        else:
            print(f"--- SKIPPING CACOI-2 for S={current_local_span_S_py} (Requires DFI for B_L) ---")

        # --- CACOI-3: Mixed Add/Sub: (A_L+B_L)-C_L ~ A_L+(B_L-C_L) ---
        s.push()
        sum_ab_c3 = define_local_op_complex_adaptive_archetype_result(define_smart_raw_add_canonical_result, A_L, B_L, P_A_val_sym, P_B_val_sym, "sAB_cacoi3")
        lhs_cacoi3 = define_local_op_complex_adaptive_archetype_result(define_smart_raw_sub_canonical_result, sum_ab_c3["val_L_sym"], C_L, P_A_val_sym, P_B_val_sym, "lhs_cacoi3")
        sub_bc_c3 = define_local_op_complex_adaptive_archetype_result(define_smart_raw_sub_canonical_result, B_L, C_L, P_A_val_sym, P_B_val_sym, "sBC_cacoi3")
        rhs_cacoi3 = define_local_op_complex_adaptive_archetype_result(define_smart_raw_add_canonical_result, A_L, sub_bc_c3["val_L_sym"], P_A_val_sym, P_B_val_sym, "rhs_cacoi3")
        prop_cacoi3 = avc_equiv_local_val(lhs_cacoi3["val_L_sym"], rhs_cacoi3["val_L_sym"], P_A_val_sym, P_B_val_sym)
        setup_cacoi3 = (sum_ab_c3["defining_assertions"] + lhs_cacoi3["defining_assertions"] + 
                        sub_bc_c3["defining_assertions"] + rhs_cacoi3["defining_assertions"])
        prove_or_find_counterexample(s, f"CACOI-3 Mixed Add/Sub (S={current_local_span_S_py})", setup_cacoi3, prop_cacoi3,
                                     [P_A_val_sym,P_B_val_sym,A_L,B_L,C_L,lhs_cacoi3["val_L_sym"],rhs_cacoi3["val_L_sym"]],
                                     op_result_dicts_for_debug=[sum_ab_c3, lhs_cacoi3, sub_bc_c3, rhs_cacoi3])
        s.pop()
        
        # --- CACOI-5: Iterated Subtraction from Areo: (((AS_L - Fp1_L) - Fp2_L) - Fp3_L) ~ AS_L ---
        if current_local_span_S_py >= 4: 
            ...
            term1_c5 = define_local_op_complex_adaptive_archetype_result(define_smart_raw_sub_canonical_result, P_B_val_sym, Fp1_L_coi5, P_A_val_sym, P_B_val_sym, "t1_cacoi5")
            term2_c5 = define_local_op_complex_adaptive_archetype_result(define_smart_raw_sub_canonical_result, term1_c5["val_L_sym"], Fp2_L_coi5, P_A_val_sym, P_B_val_sym, "t2_cacoi5")
            lhs_cacoi5 = define_local_op_complex_adaptive_archetype_result(define_smart_raw_sub_canonical_result, term2_c5["val_L_sym"], Fp3_L_coi5, P_A_val_sym, P_B_val_sym, "lhs_cacoi5")
            
            prop_cacoi5 = is_local_AS_val(lhs_cacoi5["val_L_sym"], P_B_val_sym)
            setup_cacoi5 = (term1_c5["defining_assertions"] + term2_c5["defining_assertions"] + lhs_cacoi5["defining_assertions"])
            prove_or_find_counterexample(s, f"CACOI-5 Iterated Sub from AS_L ~ AS_L (S={current_local_span_S_py})", setup_cacoi5, prop_cacoi5,
                                         [P_A_val_sym,P_B_val_sym,Fp1_L_coi5,Fp2_L_coi5,Fp3_L_coi5,lhs_cacoi5["val_L_sym"]], 
                                         op_result_dicts_for_debug=[term1_c5, term2_c5, lhs_cacoi5])
            s.pop()
        else:
            print(f"--- SKIPPING CACOI-5 for S={current_local_span_S_py} (Requires S>=4 for 3 distinct DFIs) ---")

        # --- CACOI-6: Path Dependence from Additive Non-Associativity ---
        if current_local_span_S_py >= 5: 
            s.push()
            s.add_assertion(is_local_DFI_val(A_L, P_A_val_sym, P_B_val_sym)) # X
            s.add_assertion(is_local_DFI_val(B_L, P_A_val_sym, P_B_val_sym)) # Y
            s.add_assertion(is_local_DFI_val(C_L, P_A_val_sym, P_B_val_sym)) # Z
            s.add_assertion(is_local_DFI_val(W_L, P_A_val_sym, P_B_val_sym)) # W

            sum_ab_c6 = define_local_op_complex_adaptive_archetype_result(define_smart_raw_add_canonical_result, A_L, B_L, P_A_val_sym, P_B_val_sym, "sAB_cacoi6")
            lhs_add_c6 = define_local_op_complex_adaptive_archetype_result(define_smart_raw_add_canonical_result, sum_ab_c6["val_L_sym"], C_L, P_A_val_sym, P_B_val_sym, "lhsAdd_cacoi6")
            sum_bc_c6 = define_local_op_complex_adaptive_archetype_result(define_smart_raw_add_canonical_result, B_L, C_L, P_A_val_sym, P_B_val_sym, "sBC_cacoi6")
            rhs_add_c6 = define_local_op_complex_adaptive_archetype_result(define_smart_raw_add_canonical_result, A_L, sum_bc_c6["val_L_sym"], P_A_val_sym, P_B_val_sym, "rhsAdd_cacoi6")
            
            # CACOI-6.1: (LHS_add) * W_L ~ (RHS_add) * W_L
            lhs_mul_c6 = define_local_op_complex_adaptive_archetype_result(define_raw_mul_canonical_result, lhs_add_c6["val_L_sym"], W_L, P_A_val_sym, P_B_val_sym, "lhsMul_cacoi6")
            rhs_mul_c6 = define_local_op_complex_adaptive_archetype_result(define_raw_mul_canonical_result, rhs_add_c6["val_L_sym"], W_L, P_A_val_sym, P_B_val_sym, "rhsMul_cacoi6")
            prop_cacoi61 = avc_equiv_local_val(lhs_mul_c6["val_L_sym"], rhs_mul_c6["val_L_sym"], P_A_val_sym, P_B_val_sym)
            setup_cacoi61 = (sum_ab_c6["defining_assertions"] + lhs_add_c6["defining_assertions"] + sum_bc_c6["defining_assertions"] + rhs_add_c6["defining_assertions"] +
                             lhs_mul_c6["defining_assertions"] + rhs_mul_c6["defining_assertions"])
            prove_or_find_counterexample(s, f"CACOI-6.1 PathDepMul (S={current_local_span_S_py})", setup_cacoi61, prop_cacoi61,
            ...
            # CACOI-6.2: (LHS_add) / W_L ~ (RHS_add) / W_L (W_L is DFI already constrained)
            lhs_div_c6 = define_local_op_complex_adaptive_archetype_result(define_raw_div_canonical_result, lhs_add_c6["val_L_sym"], W_L, P_A_val_sym, P_B_val_sym, "lhsDiv_cacoi6")
            rhs_div_c6 = define_local_op_complex_adaptive_archetype_result(define_raw_div_canonical_result, rhs_add_c6["val_L_sym"], W_L, P_A_val_sym, P_B_val_sym, "rhsDiv_cacoi6")
            prop_cacoi62 = avc_equiv_local_val(lhs_div_c6["val_L_sym"], rhs_div_c6["val_L_sym"], P_A_val_sym, P_B_val_sym)
            # Re-use setup from 6.1 for add parts, add definitions for div parts
            setup_cacoi62 = (sum_ab_c6["defining_assertions"] + lhs_add_c6["defining_assertions"] + sum_bc_c6["defining_assertions"] + rhs_add_c6["defining_assertions"] +
                             lhs_div_c6["defining_assertions"] + rhs_div_c6["defining_assertions"])
            prove_or_find_counterexample(s, f"CACOI-6.2 PathDepDiv (S={current_local_span_S_py})", setup_cacoi62, prop_cacoi62,
            ...
            print(f"--- SKIPPING CACOI-6 for S={current_local_span_S_py} (Additive non-assoc stress test for S>=5) ---")

        del s
        print("-" * 80)

    print("\n====== AVC Complex Adaptive Chained Operation Integrity Test Complete ======")