...
def run_smt_foundational_tests(omega_values_to_test: List[int]):
    ...
    # Total approx = 14 + 7 + 7 + 3 = 31
    num_intended_smt_tests_approx = 31 
    ...
    for omega_val in omega_values_to_test:
        ...
        smt_test_additive_quasigroup_existence(omega_val) # New
        smt_test_additive_power_associativity(omega_val)   # New
        smt_test_additive_left_alternative_law(omega_val) # New
