...
def run_identity_catalogue_tests_scaled(Omega_val: int):
    ...
    results_summary = {}
    solver_options = {"random-seed": 42} # Basic option CVC5 usually accepts
    # with Solver(name="cvc5", solver_options=solver_options, logic="QF_UFLIA") as s: # Original
    with Solver(name="z3", solver_options=solver_options) as s: # Try with AUFLIA for quantifiers 
