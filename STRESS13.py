...
def run_smt_foundational_tests(omega_values_to_test: List[int]):
    ...
    # Previous approx 32 top-level function calls.
    # New: unio_mul_zu_outcome (1), dfi_haven_add (1), dfi_haven_mul (1), sub_no_lid (1), div_uncon_rt_fail (1)
    # Total approx = 32 + 5 = 37 test function suites
    num_intended_smt_tests_approx = 37 
    ...
    for omega_val in omega_values_to_test:
        ...
        smt_test_unio_mul_zero_aspect_outcome(omega_val) # New
        
        # === DFI Properties ===
        smt_test_dfi_non_closure_add(omega_val) 
        smt_test_dfi_non_closure_mul(omega_val) 
        smt_test_dfi_non_closure_div(omega_val) 
        smt_test_dfi_haven_explicit_add(omega_val) # New
        smt_test_dfi_haven_explicit_mul(omega_val) # New
        ...
        smt_test_subtraction_no_left_identity_unio(omega_val) # New
        ...
        smt_test_division_unconstrained_round_trip_failure(omega_val) # New
